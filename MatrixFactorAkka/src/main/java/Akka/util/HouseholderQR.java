...
public class HouseholderQR {
	...
	public HouseholderQR(Matrix a){
		this.A =new Matrix(a.getRow(), a.getCol());
		MatrixOp.deepCopy(this.A, a);
		tempA=A;
	}
	...
	public void deal(int loc ){
		...
		if(Math.sqrt(VectorOp.norm(u))-0<10e-10){
...
//		matrix.elemMatrix[2][2] = -41;
		...
		MatrixOp.matrixInit(matrix);
		matrix.print();
		//MatrixOp.matrixMultimatrix(matrix, MatrixOp.matrixInverse(matrix)).print();;
