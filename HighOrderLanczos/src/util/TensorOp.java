...
public static Tensor   multiNum1(Tensor tensor1,int p){
	...
	public static void main(String []args){
		Tensor tensor1 = new Tensor(2,10,10);
		Tensor tensor2 = new Tensor(1,10);
		tensorInit(tensor2);
		tensorInit(tensor1);
		...
		System.out.println("------");
		tensor2.print();
		tensor1=multiOrder(tensor1, tensor2);
		multiOrder(tensor1, tensor2).print();
		//TensorOp.tesorSubStraction(tensor1, tensor1,2).print();
		System.out.println(TensorOp.norm2(tensor1));
